package com.memento.android.assistlibrary.theme;

import android.support.annotation.DrawableRes;
import android.support.annotation.StringRes;
import android.support.annotation.StyleRes;

import com.memento.android.assistlibrary.R;
...
public class MaterialTheme {
    ...
    public MaterialTheme(@StringRes int nameResId, @StyleRes int themeResId, @DrawableRes int drawResId) {
