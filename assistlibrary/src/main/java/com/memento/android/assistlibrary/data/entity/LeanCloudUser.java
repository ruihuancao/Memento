...
public class LeanCloudUser extends APIError implements Parcelable {
    ...
    public LeanCloudUser() {
    }

    protected LeanCloudUser(Parcel in) {
    ...
    public static final Parcelable.Creator<LeanCloudUser> CREATOR = new Parcelable.Creator<LeanCloudUser>() {
        @Override
        public LeanCloudUser createFromParcel(Parcel source) {
            return new LeanCloudUser(source);
        }

        @Override
        public LeanCloudUser[] newArray(int size) {
            return new LeanCloudUser[size];
        }
    };
}
