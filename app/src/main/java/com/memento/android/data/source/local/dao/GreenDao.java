package com.memento.android.data.source.local.dao;

import android.content.Context;
import android.database.sqlite.SQLiteDatabase;
import android.util.Log;

import com.memento.android.data.config.LocalConfig;

import org.greenrobot.greendao.database.Database;

import static com.memento.android.data.source.local.dao.DaoMaster.dropAllTables;
